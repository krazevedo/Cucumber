...
Cenario: Validar relatório Rework por Sprint

	Dado que eu acesse o goal
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Sprint"
	Então deverá estar equivalente os valores do Gráfico e da Drill

Cenario: Validar relatório Rework por Mês

	Dado que eu acesse o goal
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Month"
	Então deverá estar equivalente os valores do Gráfico e da Drill
...
Cenario: Validar Metrics Status Not Applicable
	...
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Month" no periodo de "07/01/2015" a "07/31/2015"
...
Cenario: Validar Metrics Status Disagree
	...
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Month" no periodo de "03/01/2015" a "03/31/2015"
...
Cenario: Validar Metrics Status Endorse
	...
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Month" no periodo de "04/01/2015" a "04/30/2015"
...
Cenario: Validar Metrics Status Pending
	...
	Quando eu acessar "all reports"
	E escolher o cliente "CI&T" e projeto "GOAL"
	E selecionar o dashboard "KPIs and SLAs" com relatório "Rework" agrupado por "Sprint" no periodo de "04/01/2015" a "04/30/2015"
